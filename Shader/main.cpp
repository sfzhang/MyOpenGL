...
int main()
{
    ...
    // 4. vbo has been registered as vertex attribute's bound vertex buffer object, so it can be unbound here
    glBindBuffer(GL_ARRAY_BUFFER, 0);

    // 5. vao can be unbound in case modify accidentally
    glBindVertexArray(0);
